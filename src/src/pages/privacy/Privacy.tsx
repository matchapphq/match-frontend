      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 relative">
        ...
        <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl rounded-2xl p-6 sm:p-8 border border-gray-200/50 dark:border-gray-700/50 shadow-xl space-y-6">
          <section className="space-y-3">
            <h2 className="text-xl text-gray-900 dark:text-white">1. Données collectées</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-xl text-gray-900 dark:text-white">2. Utilisation des données</h2>
            <p className="text-gray-700 dark:text-gray-300">
          ...
          <section className="space-y-3">
            <h2 className="text-xl text-gray-900 dark:text-white">3. Conservation</h2>
            <p className="text-gray-700 dark:text-gray-300">
          ...
          <section className="space-y-3">
            <h2 className="text-xl text-gray-900 dark:text-white">4. Vos droits</h2>
            <p className="text-gray-700 dark:text-gray-300">
