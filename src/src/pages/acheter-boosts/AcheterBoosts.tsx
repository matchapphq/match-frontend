      ...
      <div className="p-4 sm:p-6 lg:p-8 max-w-[1200px] mx-auto pb-24 lg:pb-8">
        ...
        <div className="mb-6 sm:mb-8">
          <button
            ...
            className="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 mb-4 flex items-center gap-2 transition-colors disabled:opacity-50"
          >
            ← Retour
          </button>
              ...
              <div className="space-y-4">
                {boostPacks.map((pack) => (
                  <button
                    ...
                    disabled={isProcessing}
                    className={`w-full text-left transition-all rounded-xl sm:rounded-2xl border-2 p-5 sm:p-6 relative overflow-hidden group disabled:opacity-50 disabled:cursor-not-allowed ${
                ...
                return (
                  <>
                    ...
                    <button
                      ...
                      disabled={isProcessing}
                      className="w-full px-6 py-4 bg-gradient-to-br from-[#5a03cf] to-[#7a23ef] text-white rounded-xl hover:shadow-xl hover:shadow-[#5a03cf]/30 transition-all flex items-center justify-center gap-2 group text-base mb-4 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:shadow-none"
                    >
                      {isProcessing ? (
                        <>
