  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      ...
      <div className="mb-12">
        ...
        <p className="text-lg text-gray-700">Gérez vos préférences de notifications</p>
      </div>
      ...
      <div className="bg-white/70 backdrop-blur-xl rounded-xl shadow-sm border border-gray-200/50 p-8 mb-6">
        ...
        <p className="text-gray-600 mb-6">Recevez des emails pour rester informé</p>
        ...
        <div className="space-y-4">
          <div className="bg-gray-50/50 backdrop-blur-sm rounded-xl p-5 border border-gray-200/30 flex items-center justify-between">
            ...
            <button
              ...
              className={`relative w-14 h-8 rounded-full transition-colors ${
                emailReservations ? 'bg-gradient-to-r from-[#5a03cf] to-[#9cff02]' : 'bg-gray-300'
              }`}
            >
              <span
          ...
          <div className="bg-gray-50/50 backdrop-blur-sm rounded-xl p-5 border border-gray-200/30 flex items-center justify-between">
            ...
            <button
              ...
              className={`relative w-14 h-8 rounded-full transition-colors ${
                emailMatchs ? 'bg-gradient-to-r from-[#5a03cf] to-[#9cff02]' : 'bg-gray-300'
              }`}
            >
              <span
                className={`absolute top-1 left-1 w-6 h-6 bg-white rounded-full transition-transform ${
      ...
      <div className="bg-white/70 backdrop-blur-xl rounded-xl shadow-sm border border-gray-200/50 p-8 mb-6">
        ...
        <p className="text-gray-600 mb-6">Notifications instantanées sur vos appareils</p>
        ...
        <div className="space-y-4">
          <div className="bg-gray-50/50 backdrop-blur-sm rounded-xl p-5 border border-gray-200/30 flex items-center justify-between">
            ...
            <button
              ...
              className={`relative w-14 h-8 rounded-full transition-colors ${
                pushReservations ? 'bg-gradient-to-r from-[#5a03cf] to-[#9cff02]' : 'bg-gray-300'
              }`}
            >
              <span
                className={`absolute top-1 left-1 w-6 h-6 bg-white rounded-full transition-transform ${
          ...
          <div className="bg-gray-50/50 backdrop-blur-sm rounded-xl p-5 border border-gray-200/30 flex items-center justify-between">
            ...
            <button
              ...
              className={`relative w-14 h-8 rounded-full transition-colors ${
                pushRappels ? 'bg-gradient-to-r from-[#5a03cf] to-[#9cff02]' : 'bg-gray-300'
              }`}
            >
              <span
                className={`absolute top-1 left-1 w-6 h-6 bg-white rounded-full transition-transform ${
