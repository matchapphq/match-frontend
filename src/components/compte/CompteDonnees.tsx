  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      ...
      <div className="mb-12">
        ...
        <p className="text-lg text-gray-700">Gérez vos données personnelles et vos préférences de confidentialité</p>
      </div>
      ...
      <div className="bg-white/70 backdrop-blur-xl rounded-xl shadow-sm border border-gray-200/50 p-6 mb-6">
        ...
        <p className="text-gray-600 mb-6">Téléchargez une copie de toutes vos données personnelles</p>
        
        <div className="bg-gray-50/50 backdrop-blur-sm rounded-xl p-5 border border-gray-200/30 mb-4">
      ...
      <div className="bg-white/70 backdrop-blur-xl rounded-xl shadow-sm border border-gray-200/50 p-6 mb-6">
        ...
        <p className="text-gray-600 mb-6">Gérez vos préférences de communication et d'utilisation des données</p>

        <div className="space-y-4">
          <div className="bg-gray-50/50 backdrop-blur-sm rounded-xl p-5 border border-gray-200/30 flex items-center justify-between">
            ...
            <button
              ...
              className={`relative w-14 h-8 rounded-full transition-colors ${
                settings.emailNotifications ? 'bg-gradient-to-r from-[#5a03cf] to-[#9cff02]' : 'bg-gray-300'
              }`}
            >
              <span
          ...
          <div className="bg-gray-50/50 backdrop-blur-sm rounded-xl p-5 border border-gray-200/30 flex items-center justify-between">
            ...
            <button
              ...
              className={`relative w-14 h-8 rounded-full transition-colors ${
                settings.smsNotifications ? 'bg-gradient-to-r from-[#5a03cf] to-[#9cff02]' : 'bg-gray-300'
              }`}
            >
              <span
                className={`absolute top-1 left-1 w-6 h-6 bg-white rounded-full transition-transform ${
          ...
          <div className="bg-gray-50/50 backdrop-blur-sm rounded-xl p-5 border border-gray-200/30 flex items-center justify-between">
            ...
            <button
              ...
              className={`relative w-14 h-8 rounded-full transition-colors ${
                settings.analyticsConsent ? 'bg-gradient-to-r from-[#5a03cf] to-[#9cff02]' : 'bg-gray-300'
              }`}
            >
              <span
                className={`absolute top-1 left-1 w-6 h-6 bg-white rounded-full transition-transform ${
          ...
          <div className="bg-gray-50/50 backdrop-blur-sm rounded-xl p-5 border border-gray-200/30 flex items-center justify-between">
            ...
            <button
              ...
              className={`relative w-14 h-8 rounded-full transition-colors ${
                settings.marketingConsent ? 'bg-gradient-to-r from-[#5a03cf] to-[#9cff02]' : 'bg-gray-300'
              }`}
            >
              <span
                className={`absolute top-1 left-1 w-6 h-6 bg-white rounded-full transition-transform ${
      ...
      <div className="bg-white/70 backdrop-blur-xl rounded-xl shadow-sm border border-gray-200/50 p-6 mb-6">
        ...
        <p className="text-gray-600 mb-6">Informations sur l'utilisation des cookies</p>
        ...
        <button 
          className="px-6 py-3 text-[#5a03cf] bg-white/50 backdrop-blur-sm border border-gray-200/50 rounded-xl hover:bg-white/70 transition-all"
          style={{ fontWeight: '600' }}
        >
      ...
      <div className="bg-white/70 backdrop-blur-xl rounded-xl shadow-sm border border-gray-200/50 p-6 mb-6">
        ...
        <p className="text-gray-600 mb-6">Conformément au RGPD, vous disposez de plusieurs droits</p>
      ...
      <div className="bg-red-50/50 backdrop-blur-xl rounded-xl shadow-sm border border-red-200/30 p-6">
        <h2 className="text-2xl mb-1" style={{ fontWeight: '600', color: '#dc2626' }}>
          Suppression du compte
        </h2>
        <p className="text-gray-700 mb-6">Cette action est irréversible. Toutes vos données seront définitivement supprimées.</p>

        <div className="bg-white/50 backdrop-blur-sm rounded-xl p-5 border border-red-200/30 mb-4">
          <p className="text-gray-700 mb-2" style={{ fontWeight: '600' }}>
        ...
        <button 
          className="px-6 py-3 bg-red-500/90 text-white rounded-xl hover:bg-red-600 transition-all shadow-sm"
          style={{ fontWeight: '600' }}
        >
