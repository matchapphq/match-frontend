          ...
          <div className="relative z-10 h-full flex flex-col justify-between space-y-3 pt-3 px-10 pb-8">
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <span
                  className="text-6xl"
                  style={{ fontWeight: "900", color: "#9cff02" }}
                >
          ...
          <div className="bg-white/70 backdrop-blur-xl rounded-3xl shadow-sm border border-gray-200/50 p-10">
            ...
            <div className="text-center mb-10">
              <h2
                ...
                style={{ fontWeight: "700", color: "#5a03cf" }}
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="text-right">
                  <button
                    type="button"
                    className="text-sm text-[#5a03cf] hover:underline transition-all cursor-pointer"
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-gradient-to-r from-[#5a03cf] to-[#9cff02] text-white py-4 rounded-xl hover:brightness-105 hover:scale-[1.01] transition-all shadow-sm disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
                style={{ fontWeight: "600" }}
              >
                {isLoading ? (
