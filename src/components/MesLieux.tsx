      ...
      <div ref={listeRef} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {etablissements.map((etablissement) => (
          <div
            ...
            className="bg-white/70 backdrop-blur-xl rounded-xl border-2 border-transparent bg-clip-padding overflow-hidden hover:scale-[1.02] transition-all cursor-pointer group"
            style={{
              backgroundImage: 'linear-gradient(white, white), linear-gradient(135deg, #9cff02 0%, #5a03cf 100%)',
              backgroundOrigin: 'border-box',
              backgroundClip: 'padding-box, border-box',
